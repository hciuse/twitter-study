...
ggsave("./plots/TimingOfInfections_Twitter_without_Muspad.pdf", dpi = 500, w = 12, h = 7.5)
ggsave("./plots/TimingOfInfections_Twitter_without_Muspad.png", dpi = 500, w = 12, h = 7.5)
